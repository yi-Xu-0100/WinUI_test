...
public partial class P1ViewModel : ObservableRecipient, INavigationAware
{
    // TODO: Set the default URL to display.
    [ObservableProperty]
    private Uri source = new("https://example.com/");
    ...
    public P1ViewModel(IWebViewService webViewService)
    {
