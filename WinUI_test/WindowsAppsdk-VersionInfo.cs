...
namespace Microsoft.WindowsAppSDK
{
    ...
    internal class Release
    {
        ...
        internal const uint MajorMinor = 0x00010005;
    ...
    namespace Runtime
    {
        ...
        internal class Version
        {
            ...
            internal const ulong UInt64 = 0x1389009F00370000;

            /// The version of the Windows App SDK runtime, as a string (const wchar_t*); for example, "1000.446.804.0".
            internal const string DotQuadString = "5001.159.55.0";
        }
        ...
        namespace Packages
        {
            internal class Framework
            {
                ...
                internal const string PackageFamilyName = "Microsoft.WindowsAppRuntime.1.5_8wekyb3d8bbwe";
            }
            internal class Main
            {
                /// The Windows App SDK runtime's Main package's family name.
                internal const string PackageFamilyName = "MicrosoftCorporationII.WinAppRuntime.Main.1.5_8wekyb3d8bbwe";
            }
            ...
            namespace DDLM
            {
                internal class X86
                {
                    ...
                    internal const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.5001.159.55.0-x8_8wekyb3d8bbwe";
                }
                internal class X64
                {
                    /// The Windows App SDK runtime's Dynamic Dependency Lifetime Manager (DDLM) package's family name, for x64.
                    internal const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.5001.159.55.0-x6_8wekyb3d8bbwe";
                }
                internal class Arm64
                {
                    ...
                    internal const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.5001.159.55.0-a6_8wekyb3d8bbwe";
                }
            }
        }
    }
